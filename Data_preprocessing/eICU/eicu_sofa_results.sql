--Based on the code from https://github.com/nus-mornin-lab/oxygenation_kc
...
lab AS (
SELECT * FROM `oxgenator.eicu.lab`),

vitalperiodic AS (
SELECT * FROM `oxgenator.eicu.vitalperiodic`),

vitalaperiodic AS (
SELECT * FROM `oxgenator.eicu.vitalaperiodic`),

infusiondrug AS (
SELECT * FROM `oxgenator.eicu.infusiondrug`),

respiratorycare AS (
SELECT * FROM `oxgenator.eicu.respiratorycare`),

treatment AS (
SELECT * FROM `oxgenator.eicu.treatment`),

careplangeneral AS (
SELECT * FROM `oxgenator.eicu.careplangeneral`),

physicalexam AS (
SELECT * FROM `oxgenator.eicu.physicalexam`),

diag AS (
SELECT * FROM `oxgenator.eicu.diagnosis`),

chart AS (
SELECT * FROM `oxgenator.eicu.nursecharting`),

apsiii_raw AS (
SELECT * FROM `oxgenator.eicu.apachepatientresult`),

intakeoutput AS (
SELECT * FROM `oxgenator.eicu.intakeoutput`),

respchart AS (
SELECT * FROM `oxgenator.eicu.respiratorycharting`),
